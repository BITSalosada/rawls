...
object Dependencies {
  ...
  val workbenchGoogle2: ModuleID = "org.broadinstitute.dsde.workbench" %% "workbench-google2" % "0.6-8bae8e8" % "provided" excludeAll(excludeWorkbenchModel, excludeWorkbenchUtil)
